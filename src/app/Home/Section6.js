            ...
            <div className={`${styles.Section6container} container`}>
                <div className={` row ${styles.Section6Row}`}>
                    <div className={`col-md-12 ${styles.Section6colmd7}`}>
                        <button className={`${styles.Section6Button} btn`} data-aos="fade-up" data-aos-delay="100">WHY Dr. RAVI</button>
                        <h1 className={`${styles.Section6Title}`} data-aos="fade-up" data-aos-delay="200">
                            What Sets <br />Dr. Ravi Apart
                        </h1>
                        <div className={`container ${styles.featuresSection}`} data-aos="fade-up" data-aos-delay="300">
                            <div className="row">
                ...
                <div className='row g-0' data-aos="fade-up" data-aos-delay="300">

            ...
            <div className={`row align-items-stretch ${styles.fullHeightRow}`}>
                <div className={`col-lg-7 ${styles.colFullHeight}`}>
                    <div className={`${styles.aboutBox} p-5 p-lg-5`}>
                        ...
                        <p className="text-white mb-3">
                            Dr. Uday Ravi has been practicing proctology for more than a decade. He has done 1000s of proctology cases in Bangalore. He is one of the best and leading proctologist in Bangalore. Surgically advanced techniques, and latest treatment modalities with laser & stapler, are used to ensure that post operative follow-ups & dressings are minimal, patients are more comfortable and have less pain. He ensures patients can resume their normal lifestyle in a short period of time.
                        </p>
                    </div>
                </div>
